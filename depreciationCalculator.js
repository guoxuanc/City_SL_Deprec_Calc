function calculateDepreciation(acquisitionCost, usefulLife, depreciationEffectiveDate, depreciatedToFiscalYear) {
  ...
  function handleSubmit(event) {
    ...
    const result = calculateDepreciation(acquisitionCost, usefulLife, depreciationEffectiveDate, depreciatedToFiscalYear);
